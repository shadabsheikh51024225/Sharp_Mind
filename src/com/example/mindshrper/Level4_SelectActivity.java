...
public class Level4_SelectActivity extends Activity implements OnClickListener {
	View v;
	int q=0;
	SQLiteDatabase mydb;
	String[] get;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_level4__select);
		Intent in=getIntent();
		Bundle bn=in.getExtras();
		Score =bn.getInt("Score");
		mode=bn.getString("mode");
		 this.setTitle(mode + "  Level 4");
		get=bn.getStringArray("DisWord");
		//mode(mode);
		adddata();
	}
	public void adddata()
	...
	public void onClick(View v) {
		...
		else if(cnt == 12)
		{
			...
			Intent in=new Intent(getApplicationContext(),Level5Activity.class);
			in.putExtra("Score", Score);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.level4__select, menu);
		return true;
	}
	@Override
