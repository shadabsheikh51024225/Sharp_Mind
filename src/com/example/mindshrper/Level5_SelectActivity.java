...
public class Level5_SelectActivity extends Activity implements OnClickListener {
	View v;
	int q=0;
	SQLiteDatabase mydb;
	String[] get;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_level5__select);
		adddata();
	}
	public void adddata()
	{
	...
	public void onClick(View v) {
		...
		else if(cnt == 16)
		{
			...
			Intent in=new Intent(getApplicationContext(),Level6Activity.class);
			in.putExtra("Score", Score);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.level5__select, menu);
		return true;
	}
	@Override
