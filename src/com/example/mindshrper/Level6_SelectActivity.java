...
@SuppressLint("NewApi")
public class Level6_SelectActivity extends Activity implements OnClickListener, android.view.View.OnClickListener {
	View v;
	int q=0;
	SQLiteDatabase mydb;
	String[] get;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_level6__select);
		Intent i= getIntent();
		Bundle b = i.getExtras();
		get=b.getStringArray("DisWord");
		Score= b.getInt("Score");
		mode = b.getString("mode");
		this.setTitle(mode + "  Level 6");
		//mode(mode);
		adddata();
	}
	public void adddata()
	{
		try{
			...
			Button buttonarray[] = new Button[31];
	...
	public void onClick(View v) {
		...
		else if(cnt == 20)
		{
			...
			Intent in=new Intent(getApplicationContext(),Level7Activity.class);
			in.putExtra("Score", Score);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.level6__select, menu);
		return true;
	}
	@Override
